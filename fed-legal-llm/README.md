---
tags: [quickstart, llm, federated-learning, lora, legal-ai]
dataset: [Fed-Legal]
...
```shell
flwr new @yan-gao/fed-legal-llm
```
...
* `dataset-name`: Hugging Face dataset repo
...
dataset-name = "flwrlabs/fed-legal"
load-in-4bit = true
